...
sed -n "${start_line},${next_line}p" ${path_to_working}/magic_thesis/scripts/bash_scripts/annotation/repeat_modeler/command_txt/repeat_modeler_commands.txt | /bin/bash
