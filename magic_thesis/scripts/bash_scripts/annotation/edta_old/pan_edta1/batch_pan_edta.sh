...
#SBATCH --error=/global/home/users/mtandean/scratch/magic_thesis/log_slurm/annotation/edta1_logs/pan_edta%A_%a.err
#SBATCH --output=/global/home/users/mtandean/scratch/magic_thesis/log_slurm/annotation/edta1_logs/pan_edta%A_%a.out
...
sh panEDTA.sh -g pan_edta_genome_list.txt -c $cds_loc -l $curatedlib_loc -t 9 -a 0 -o 1
