...
do
	...
	echo "perl ~/bin/EDTA/EDTA.pl --genome ${path_to_working}/magic_thesis/intermediate_data/assembly/scaffolded_assemblies/$i --curatedlib $curatedlib_loc --cds $cds_loc --anno 1 --evaluate 1 --threads 15 --overwrite 0 --step anno"
done
